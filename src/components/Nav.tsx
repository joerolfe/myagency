...
export default function Nav() {
  ...
  return (
    <div className="fixed top-4 left-0 right-0 z-50 flex flex-col items-center gap-2 px-4">
      ...
      <div
        className={`md:hidden w-full max-w-[calc(100vw-2rem)] bg-[#111]/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.35)] overflow-hidden transition-all duration-200 ${
