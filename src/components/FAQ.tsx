...
export default function FAQ() {
  ...
  return (
    <section className="py-16 md:py-32 px-4 sm:px-6 bg-white border-t border-[#ebebeb]">
      <div className="max-w-5xl mx-auto">
        ...
        >
          {faqs.map((faq, i) => (
            <div key={i}>
              <button
                className="w-full text-left px-4 py-5 sm:px-7 sm:py-6 flex items-center justify-between gap-3 sm:gap-6 hover:bg-stone transition-colors duration-150 group"
              ...
              <AnimatePresence initial={false}>
                {open === i && (
                  ...
                  >
                    <div className="pl-4 pr-4 pb-5 sm:pl-5 sm:pr-7 sm:pb-6 bg-stone border-l-2 border-gold">
