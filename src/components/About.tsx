    ...
    >
      ...
      >
        ...
        <div className="relative mb-6">
          <motion.div
            className="w-28 h-28 sm:w-36 sm:h-36 md:w-40 md:h-40 rounded-2xl border-2 border-gold/40 overflow-hidden"
            whileHover={{ scale: 1.06 }}
            transition={{ type: "spring", stiffness: 300, damping: 20 }}
          >
            <Image src="/joe.png" alt="Joseph Rolfe" width={160} height={160} className="w-full h-full object-cover object-[center_22%]" />
          </motion.div>
...
export default function About() {
  return (
    <section className="relative pt-40 md:pt-48 pb-24 md:pb-32 px-6 bg-ink overflow-hidden -mt-16">
      ...
      <div id="about" className="relative max-w-6xl mx-auto scroll-mt-20">
